...
const ObjTrailer = {
  ...
  text:  "Dans un monde ravagé par des titans mangeurs d'homme , les rares survivants n'ont d'autre choix pour survivre que de se barricader dans une cité-forteresse.",
