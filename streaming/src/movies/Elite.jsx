...
const ObjTrailer = {
  ...
  title: "Elite",
  text: "Lorsque trois ados issus de la classe ouvrière accèdent à une école élitiste d'Espagne, le fossé qui les sépare des élèves fortunés conduit à la pire des tragédies.",
