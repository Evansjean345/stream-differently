...
const ObjTrailer = {
    ...
    text: "Anastasia Steele, 21 ans, étudiante en littérature anglaise à l'université d'État de Washington (WSU) près de Vancouver, se voit confier par sa colocataire Kate Kavanagh l'interview de Christian Grey.",
