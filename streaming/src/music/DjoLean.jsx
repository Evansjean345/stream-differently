...
import djoLeanOne from "../images/djoLeanOne.jpeg";

const ObjTrailer = {
  videoTrailer: djoLeanOne,
  title: "Djo Lean",
  text: "MARIO'KART",
  videoModal: "https://www.youtube-nocookie.com/embed/MbCN5bq6D_k",
};
...
const SecondObj = {
  ...
  text: `
  Couplet:
  Vazy déballe le cadeau mon bro 
  Elle a sciencé pour toi bila c’est une vrai go 
  Jveux le cash d’Nsikan et Ado
  Y’a personne sur mon gros lit j’ai même pas de go
  Mariokart envoie la Wii Go
  Légé couplet ça vaut même pas ce que je vaut 
  Vla de naggaz sont glock 
  Fuck les amis qui mélange la tête ta go 
  Fête, Donc direct je m’habille 
  Shout out tout mes poto de vridi 
  Fuck un polonais vive la Russie 
  Dans mon couplet comme si j’étais 1000
  Fais attention au naggaz ils sont là beaucoup aujourd’hui mais y’a rien qui est acquis 
  Il n’a rien fait de mal mais comme il est trop fan c’est lui qui demande tout les yaki*
  Comme cadeau jveux talkie-walkie chh allo @Guyro est-ce que tu me reçoit ?
  Jveux un fils comme Samu Reshevsky jamais je lui dirais mon fils tu me déçois 
  `,
};

export default function DjoLean() {
