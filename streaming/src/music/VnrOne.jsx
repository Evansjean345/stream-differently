...
const ObjTrailer = {
  ...
  title: "Simba_93",
  text: "Frestyle VNR#1",
  videoModal:"https://www.youtube-nocookie.com/embed/3k1NZ9OehUw"
};

const SecondObj = {
  title: "Lyrics",
  text: `Jsuis enrage enragé  sombre esprit déclencher la cité m’a trop changé trop changer jvais leur faire du sal pas besoin demender jsuus tjr debout j’peux pas MDébander tous les jours au four même si y’a conde tu peux devenir fou quand y’a trop d’entrée le benef de la drogue fait k’rentrer 
  Belle jeune fille veulent mtn m’frequenter 
  J’les effraie comme lés maison hantés tu paye les frais juste pour contempler et dès la veille tout est dja complet 
  Complet  
  Si c’est pour la maille l’est kon a pas fait p’tit taper des rails et trop d’sombre fait  putain d’vie d’racaille plein de méfait j’en ai ke faire la drogue m’a refait vazy j’fais m’led faire 
  Chez nous pas d’marmaille on peut traire du sal 
  Toute mon ekip est d’ail atteinte nasal 
  Mon rap a pas dfail c’est paranormal 
  Lion comme dépay jsuis pas normal 
  Conçu pas taille en tout format 
  Kan jredetaille c’est colossal
  Trop de batard ne sont plus al 
  Comme le katar j’veux l’argent du sa
  Nous on veut du pia gars pour ça on fait du mal
  `,
};

export default function VnrOne() {
